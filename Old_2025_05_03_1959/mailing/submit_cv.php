...
$mail_subject= 'CV sent from website  :'. date("Y-m-d h:i");
$mail_subject= utf8_decode($mail_subject);

$mail_txt= '***Mail sent from website *** <br>'.'<br> <b>Nom : </b>'.$contact_name.'<br> <b>Prénom: </b> '.$contact_surname.'<br><br> <b> Mail:</b>  '.$contact_mail.'<br> <b> Phone: </b> '.$contact_phone.'<br><br> <b> Parlez nous de vous : </b> <br>'.$contact_message;
